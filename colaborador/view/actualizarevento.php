...
<head>
  ...
  <title>Modificar evento | Fundación Tesak</title>
  <!-- Bootstrap core CSS-->
...
echo'
                        ...
                        ?>
                        <br>
                        <a href="../view/eventos_realizados.php" class="btn btn-info btn-md" ><i class="fa fa-angle-left"></i>&nbsp;  Regresar</a>
          <div class="card card-register mx-auto mt-5">

            <div class="card-header"><h3 style="text-align:center;"><i class="fa fa-calendar-o"></i> Modificar evento</h3></div>
            <div class="card-body">
