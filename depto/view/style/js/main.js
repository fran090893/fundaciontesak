...
function buscar_grupos(consulta){
	$.ajax({
		url: '/fundaciontesak-final/depto/controller/buscar_grupo.php' ,
		type: 'POST' ,
		dataType: 'html',
...
function buscar_eventos_r(consulta){
	$.ajax({
		url: '/fundaciontesak-final/depto/controller/buscar_evento_r.php' ,
		type: 'POST' ,
		dataType: 'html',
		data: {consulta: consulta},
	})
...
function buscar_alumnos(consulta){
	$.ajax({
		url: '/fundaciontesak-final/depto/controller/buscar_alumno.php' ,
		type: 'POST' ,
		dataType: 'html',
		data: {consulta: consulta},
	})
...
function buscar_usuarios(consulta){
	$.ajax({
		url: '/fundaciontesak-final/depto/controller/buscar_usuario.php' ,
		type: 'POST' ,
		dataType: 'html',
		data: {consulta: consulta},
	})
