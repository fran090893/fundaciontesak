...
<head>
  ...
  <title>Agregar usuario | Fundación Tesak</title>
  <!-- Bootstrap core CSS-->
...
echo'
                        ...
                        <div class="alert alert-success"  id="error">
                            <button class="close" data-dismiss="alert"><span>&times;</span> </button>
                           <strong>¡Exito! </strong> El usuario ha sido agregado con exito.
                        </div>';
                         }
                        ?>
          <div class="card card-register mx-auto mt-5">
            ...
            <div class="card-body">
              <form method="POST" action="../controller/c_usuario.php">
                ...
                <div class="form-group">
                  <label for="contra_us1">Telefono</label>
                  <input class="form-control" id="telefono" name="telefono_usuario" type="text" aria-describedby="nameHelp" placeholder="Digitar telefono" required="true">
                </div>
