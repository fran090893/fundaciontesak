            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered" style="text-align:center;">
                ...
                <tbody>
                  ...
                  $query ="SELECT alumno.id_alumno, CONCAT(alumno_nombre, ' ', alumno_apellido ) AS nombre_completo, grupo.grupo_nombre AS grupo, asistencia.asistencia,departamento.departamento_nombre AS dept_alumno FROM asistencia
