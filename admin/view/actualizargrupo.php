...
<head>
  ...
  <title>Modificar grupo | Fundación Tesak</title>
  <!-- Bootstrap core CSS-->
...
echo'
                        ...
                        ?>
                        <br>
                        <a href="../view/vergrupo.php" class="btn btn-info btn-md" ><i class="fa fa-angle-left"></i>&nbsp;  Regresar</a>
          <div class="card card-register mx-auto mt-5">
            ...
            <div class="card-body">
              <form method="POST" action="../controller/c_updategrupo.php?id=<?php echo $resultado['id_grupo']; ?>">
                ...
                <div class="form-group">
                  <label for="descripcion_grupo">Descripción del grupo</label>
