      ...
      <div class="card card-register mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          <div class="form-group" style="text-align:center;">
                  <p>Nombre de usuario: <?php echo "<strong> $usuario </strong>";  ?></p>
                  <p>Teléfono: <?php echo "<strong>".$_SESSION['telefono']." </strong>";  ?></p>
                  <p>Correo electrónico: <?php echo "<strong>".$_SESSION['correo']." </strong>";  ?> </p>
          </div>
        </div>
      </div>
    </div>
