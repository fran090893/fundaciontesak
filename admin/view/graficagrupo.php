...
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/01/01')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/02/01') AND Month(fecha) = Month('2018/02/01')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/03/01')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/04/12')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/05/04')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/06/05')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/07/06')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/08/07')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/09/08')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/10/09')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/11/10')";
...
INNER JOIN alumno ON asistencia.id_alumno = alumno.id_alumno
INNER JOIN evento ON asistencia.id_evento = evento.id_evento
WHERE alumno.id_grupo = '".$id_grupo."' and asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/12/11')";
$reobtener12 = $conexion ->prepare($queridi);
$reobtener12 ->execute();
$diciembre = $reobtener12 ->fetch();


$query = "SELECT  grupo_nombre as nombre from grupo where id_grupo='".$id_grupo."' ";
