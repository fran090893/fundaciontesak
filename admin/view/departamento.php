  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
          <br>
            <h2 style="text-align:center;"><i class="fa fa-building"></i> Estadisticas de Departamentos</h2>
          <br/>
...
echo'               <tr>
                      ...
                      <a href="graficadepartamento.php?id='.$resultado['id_departamento'].' " class="btn btn-success btn-md"><i class="fa fa-edit"></i></a>&nbsp;
                      </td>
                    </tr>
