...
$consulta1 = "SELECT id_usuario, usuario_nombre, usuario_apellido, usuario,usuario_correo,usuario_telefono, cargo.cargo AS cargo, departamento.departamento_nombre AS departamento FROM usuario INNER JOIN cargo ON usuario.id_cargo=cargo.id_cargo INNER JOIN departamento ON usuario.id_departamento=departamento.id_departamento";
