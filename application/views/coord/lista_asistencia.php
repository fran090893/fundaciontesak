...
<a class="scroll-to-top rounded" href="#page-top">
  ...
  <script src="<?php echo base_url('assets/style/js/buscadores/coord/asistencia_sc_cd.js');?>"></script>
  <script src="<?php echo base_url('assets/style/js/jquery.min.js');?>"></script>
  <script src="<?php echo base_url('assets/style/js/buscadores/coord/lista_asistencia_buscar_cd.js');?>"></script>
