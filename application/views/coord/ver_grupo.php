      ...
      <div class="row">
        <div class="col-12">
          <?php
            ...
            <br/>
              <input type="text" name="busqueda_grupos_cd" id="busqueda_grupos_cd" class="form-control" placeholder="Buscar un grupo" />
           <br/>
...
<script src="<?php echo base_url('assets/style/js/buscadores/coord/buscar_grupo_cd.js');?>"></script>
