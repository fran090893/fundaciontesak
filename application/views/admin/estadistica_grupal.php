...
<div class="form-group">
  <br>
    <a href="v_buscarEstadisticaGrupal" class="btn btn-info btn-md" ><i class="fa fa-angle-left"></i>&nbsp;  Regresar</a>
</div>
<div id="container" style="min-width: 310px; height: 400px; margin: 0 auto"></div>

<script type="text/javascript">
 var a = "<?php echo $stats_r['nombre_grupo'];?>";
Highcharts.chart('container', {
    chart: {
        zoomType: 'xy'
    },
    title: {
        text: 'Asistencias reales del grupo: ' + a
    },
    subtitle: {
        text: 'Asistencia por grupos de la Fundación para la Educación Experencial Pablo Tesak'
    },
    xAxis: [{
