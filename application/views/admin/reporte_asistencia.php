<div class="content-wrapper">
        ...
        <div class="col-12">
          ...
          <br/>
            ...
            <div class="form-group" style="text-align:center;">
              <a  href="imprimirLista2?id=<?php echo $g12;?>&e=<?php echo $e12;?>" class="btn btn-primary btn-md" ><i class="fas fa-print"></i>&nbsp; Imprimir lista</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="<?php echo base_url('assets/style/js/buscadores/admin/buscar_reporte_asistencia.js');?>"></script>
