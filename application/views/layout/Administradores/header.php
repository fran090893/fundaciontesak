...
$username = ($this->session->userdata['logged_in']['s_usuario']);
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Pablo<span class="lite">Tesak</span></a>
      <!--logo end-->
      ...
      <div class="top-nav notification-row">
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <li>
                <a href="<?Php echo base_url();?>clogin/logout"><i class="icon_key_alt"></i>Cerrar sesion</a>
              </li>
                        </a>
