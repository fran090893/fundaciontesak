<?php
class Mestadistica extends CI_Model
{
  ...
  public function anualAsistenciaReal()
  {
    $c_enero = "SELECT COUNT(*) AS cantidad1 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/01/01')";
    $enero = $this->db->query($c_enero)->row();
    $resultado1 = $enero->cantidad1;

    $c_febrero = "SELECT COUNT(*) AS cantidad2 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/02/01') AND Month(fecha) = Month('2018/02/01')";
    $febrero = $this->db->query($c_febrero)->row();
    $resultado2 = $febrero->cantidad2;

    $c_marzo = "SELECT COUNT(*) AS cantidad3 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/03/01')";
    $marzo = $this->db->query($c_marzo)->row();
    $resultado3 = $marzo->cantidad3;

    $c_abril = "SELECT COUNT(*) AS cantidad4 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/04/12')";
    $abril = $this->db->query($c_abril)->row();
    $resultado4 = $abril->cantidad4;

    $c_mayo = "SELECT COUNT(*) AS cantidad5 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/05/04')";
    $mayo = $this->db->query($c_mayo)->row();
    $resultado5 = $mayo->cantidad5;

    $c_junio = "SELECT COUNT(*) AS cantidad6 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/06/05')";
    $junio = $this->db->query($c_junio)->row();
    $resultado6 = $junio->cantidad6;

    $c_julio = "SELECT COUNT(*) AS cantidad7 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/07/06')";
    $julio = $this->db->query($c_julio)->row();
    $resultado7 = $julio->cantidad7;

    $c_agosto = "SELECT COUNT(*) AS cantidad8 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/08/07')";
    $agosto = $this->db->query($c_agosto)->row();
    $resultado8 = $agosto->cantidad8;

    $c_sept = "SELECT COUNT(*) AS cantidad9 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/09/08')";
    $sept = $this->db->query($c_sept)->row();
    $resultado9 = $sept->cantidad9;

    $c_oct = "SELECT COUNT(*) AS cantidad10 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/10/09')";
    $oct = $this->db->query($c_oct)->row();
    $resultado10 = $oct->cantidad10;

    $c_nov = "SELECT COUNT(*) AS cantidad11 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/11/10')";
    $nov = $this->db->query($c_nov)->row();
    $resultado11 = $nov->cantidad11;

    $c_dic = "SELECT COUNT(*) AS cantidad12 FROM asistencia INNER JOIN evento ON asistencia.id_evento = evento.id_evento WHERE asistencia = 1 AND year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/12/11')";
  ...
  public function anualAsistenciaEsperada()
  {
    $c_enero = "SELECT COUNT(*) AS cantidad1 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/01/01')";
    $enero = $this->db->query($c_enero)->row();
    $resultado1 = $enero->cantidad1;

    $c_febrero = "SELECT COUNT(*) AS cantidad2 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/02/01') AND Month(fecha) = Month('2018/02/01')";
    $febrero = $this->db->query($c_febrero)->row();
    $resultado2 = $febrero->cantidad2;

    $c_marzo = "SELECT COUNT(*) AS cantidad3 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/03/01')";
    $marzo = $this->db->query($c_marzo)->row();
    $resultado3 = $marzo->cantidad3;

    $c_abril = "SELECT COUNT(*) AS cantidad4 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/04/12')";
    $abril = $this->db->query($c_abril)->row();
    $resultado4 = $abril->cantidad4;

    $c_mayo = "SELECT COUNT(*) AS cantidad5 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/05/04')";
    $mayo = $this->db->query($c_mayo)->row();
    $resultado5 = $mayo->cantidad5;

    $c_junio = "SELECT COUNT(*) AS cantidad6 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/06/05')";
    $junio = $this->db->query($c_junio)->row();
    $resultado6 = $junio->cantidad6;

    $c_julio = "SELECT COUNT(*) AS cantidad7 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/07/06')";
    $julio = $this->db->query($c_julio)->row();
    $resultado7 = $julio->cantidad7;

    $c_agosto = "SELECT COUNT(*) AS cantidad8 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/08/07')";
    $agosto = $this->db->query($c_agosto)->row();
    $resultado8 = $agosto->cantidad8;

    $c_sept = "SELECT COUNT(*) AS cantidad9 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/09/08')";
    $sept = $this->db->query($c_sept)->row();
    $resultado9 = $sept->cantidad9;

    $c_oct = "SELECT COUNT(*) AS cantidad10 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/10/09')";
    $oct = $this->db->query($c_oct)->row();
    $resultado10 = $oct->cantidad10;

    $c_nov = "SELECT COUNT(*) AS cantidad11 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/11/10')";
    $nov = $this->db->query($c_nov)->row();
    $resultado11 = $nov->cantidad11;

    $c_dic = "SELECT COUNT(*) AS cantidad12 FROM alumno INNER JOIN grupo ON alumno.id_grupo = grupo.id_grupo INNER JOIN evento ON grupo.id_grupo=evento.id_grupo WHERE  year(fecha) = year('2018/01/01') AND Month(fecha) = Month('2018/12/11')";
    $dic = $this->db->query($c_dic)->row();
    $resultado12 = $dic->cantidad12;

    $arreglo = array(
      'enero_e' => $resultado1,
      'febrero_e' => $resultado2,
      'marzo_e' => $resultado3,
      'abril_e' => $resultado4,
      'mayo_e' => $resultado5,
      'junio_e' => $resultado6,
      'julio_e' => $resultado7,
      'agosto_e' => $resultado8,
      'septiembre_e' => $resultado9,
      'octubre_e' => $resultado10,
      'noviembre_e' => $resultado11,
      'diciembre_e' => $resultado12
