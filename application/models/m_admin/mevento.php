...
class Mevento extends CI_Model
{
  ...
  public function buscarEventoProximo($busqueda1)
  {
    ...
    if(isset($busqueda1))
    {
      $c = "SELECT evento.id_evento,grupo.id_grupo, evento.evento_nombre,evento.fecha, grupo.grupo_nombre AS grupo FROM evento INNER JOIN grupo ON evento.id_grupo = grupo.id_grupo WHERE evento.estado=0 AND(evento.evento_nombre LIKE '".$busqueda1."%' OR grupo.grupo_nombre LIKE '".$busqueda1."%' OR evento.fecha LIKE '".$busqueda1."%')";
    }
